...
spaceguppy_sfx_modules = {
    'spaceguppy_sfx.sfx':['spaceguppy_sfx/sfx.pyx'],
    'spaceguppy_sfx.sfx_renderer': ['spaceguppy_sfx/sfx_renderer.pyx'],
    'spaceguppy_sfx.sfx_formats': ['spaceguppy_sfx/sfx_formats.pyx',],
    
}

spaceguppy_sfx_modules_c = {
    'spaceguppy_sfx.sfx': ['spaceguppy_sfx/sfx.c'],
    'spaceguppy_sfx.sfx_renderer': ['spaceguppy_sfx/sfx_renderer.c'],
    'spaceguppy_sfx.sfx_formats': ['spaceguppy_sfx/sfx_formats.c',],

}

check_for_removal = [
    'spaceguppy_sfx/sfx_renderer.c',
    'spaceguppy_sfx/sfx_formats.c',
    'spaceguppy_sfx/sfx.c'
]
...
if have_cython:
    if do_clear_existing:
        for file_name in check_for_removal:
            if isfile(file_name):
                remove(file_name)
    spaceguppy_sfx_extensions = build_extensions_for_modules_cython(
        spaceguppy_sfx_extensions, spaceguppy_sfx_modules)
else:
    spaceguppy_sfx_extensions = build_extensions_for_modules(spaceguppy_sfx_extensions,
                                                        spaceguppy_sfx_modules_c)
...
setup(
    ...
    ext_modules=spaceguppy_sfx_extensions,
    cmdclass=cmdclass,
    packages=[
        'spaceguppy_sfx',
    ],
    package_dir={'spaceguppy_sfx': 'spaceguppy_sfx'},
    package_data={'spaceguppy_sfx': ['*.pxd', ]}
)
